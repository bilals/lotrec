 ...
 * @author Bilal Said
 */
public class InfixToPrefix extends FormulaTransformer {

    public InfixToPrefix(ArrayList<Connector> connectors) {
        super(connectors);
    }
...
//        int argsCount = 0; 
//        for (String inputPart : inputFormat) {
//            if (inputPart.equals(FormulaTransformer.FORMULA)) {
//                argsCount++;
//            }
//        }

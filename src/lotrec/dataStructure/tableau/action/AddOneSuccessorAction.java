 ...
 */
public class AddOneSuccessorAction extends AbstractAction {
    ...
    public AddOneSuccessorAction(SchemeVariable sourceNodeScheme, SchemeVariable nodeScheme, Expression relationScheme) {
        super();

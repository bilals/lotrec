 ...
 * @author Bilal Said
 */
public class IsAtomicCondition extends AbstractCondition {
    ...
    public IsAtomicCondition(Expression expressionScheme) {//SchemeVariable nodeScheme,
        super();
    ...
    public Restriction createRestriction() {
        return new IsAtomicMatch(expressionScheme); // where the tests is really done
    }

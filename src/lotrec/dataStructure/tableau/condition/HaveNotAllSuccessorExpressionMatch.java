 ...
 */
public class HaveNotAllSuccessorExpressionMatch extends Restriction {
     ...
     */
    public HaveNotAllSuccessorExpressionMatch(SchemeVariable nodeScheme, Expression expressionScheme, Expression relation) {
    ...
    public void attemptToApply(Action action, Object modifier, ActionStocking actionStocking,EventMachine eventMachine) throws ProcessException {
        ...
        //this is in the case where all the successors have the expression
        return;
    }
}

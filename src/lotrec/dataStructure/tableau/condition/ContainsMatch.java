 ...
 */
public class ContainsMatch extends Restriction {
     ...
     */
    public ContainsMatch(SchemeVariable bigNodeScheme, SchemeVariable smallNodeScheme) {
    ...
    public void attemptToApply(Action action, Object modifier, ActionStocking actionStocking,EventMachine eventMachine) throws ProcessException {
        ...
        for (Enumeration enumr = smallNode.getMarkedExpressionsEnum(); enumr.hasMoreElements();) {
            Expression e = ((MarkedExpression) enumr.nextElement()).expression;
            if (!bigNode.contains(e)) {
                return;
